...
def extract_article_image(article_url):
    ...
    try:
        ...
        # 4. Последен вариант — снимка от самата статия
        ...
        print(
            ...
            f"[image] Неуспешно извличане на "
...
def extract_article_links(source):
    ...
    for link in soup.find_all(
        ...
        # Премахваме навигационни заглавия
